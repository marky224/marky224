...
🚀 **Currently Exploring**:  
I am actively **expanding my skillset into IT Automation and Data Engineering** — building ETL pipelines, working with large datasets, and diving deeper into tools like **Python**, **Kubernetes**, **Ansible**, **Virtualization** and **SQL** for endpoint management, data transformation and visualization.
